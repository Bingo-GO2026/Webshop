...
//
// Dit endpoint stuurt een echte email met een echte game-link
// zodat je de volledige flow kunt testen zonder een betaling te doen.
    ...
    return res.status(200).send(`
      <html><body style="font-family:sans-serif;padding:32px;max-width:600px">
        ...
        <p style="color:grey;font-size:0.85rem">
          Vergeet dit bestand (api/test-email.js) te verwijderen zodra alles werkt!
        </p>
      </body></html>
    `);
  } catch (err) {
